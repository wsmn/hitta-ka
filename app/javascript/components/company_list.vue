<template>
  <div class="p-4 h-full flex w-full">
    <div
      class="h-full z-20 flex p-2 md:p-4 relative bg-gray-900 shadow-xl rounded-lg border border-gray-400"
      :class="{
        'w-1/3': shouldExpand,
        'w-1/4': !shouldExpand
      }"
      ...
      >
        <div class="md:px-10 lg:px-4 xl:px-8 mt-0 lg:-mt-4 xl:mt-2">
          <div class="mb-6">
            ...
            <h1 class="font-bold text-3xl text-white inline ml-1">
              Kontrollansvariga
            </h1>
          </div>
